...
export function BlogPageHeader({ onNewBlog, canManageBlogs = false }: BlogPageHeaderProps) {
	return (
		<div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
			<div>
				<h1 className="text-base font-medium text-slate-800 sm:text-lg">Blogs</h1>
