  ...
  return (
    <section className="mt-2 border-t border-slate-200 pt-4 sm:mt-4 sm:pt-5">
      ...
      {canPostComments ? (
        ...
        <p className="mt-4 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2.5 text-xs text-slate-500 sm:mt-5 sm:text-sm">
          Comments are view-only for this blog.
        </p>
      )}
    </section>
  )
